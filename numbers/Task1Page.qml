...
Rectangle {
    ...
    ResultInfoWin {
        ...
        Component.onCompleted: {
            ok.connect(rootRect.setStateDefault)
            searchAgain.connect(rootRect.searching)
        }
    }
}
